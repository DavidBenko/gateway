...
var usageStrings = map[string]string{
	...
	"remote-endpoint-custom-function-enabled": "Whether or not Custom Function remote endpoints are enabled. Defaults to false.",
	...
	"docker-cpu-shares":         "The CPU share weight to allocate to each running docker container. Default is 0.",
