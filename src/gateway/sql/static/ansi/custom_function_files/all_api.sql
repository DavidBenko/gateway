SELECT
  ...
  custom_function_files.created_at as created_at,
  custom_function_files.updated_at as updated_at,
  custom_function_files.name as name,
  custom_function_files.body as body
FROM custom_function_files, custom_functions, apis
WHERE custom_function_files.custom_function_id = custom_functions.id
  AND custom_functions.api_id = ?
  AND custom_functions.api_id = apis.id
  AND apis.account_id = ?
ORDER BY custom_function_files.id ASC;
