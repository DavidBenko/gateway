...
func NewVM(
	...
	vm.InitCoreVM(core.VMCopy(proxyEndpoint.AccountID, proxyEndpoint.APIID, proxyEndpoint.EnvironmentID, keyStore, endpointStore, prepare), logPrint, logPrefix, &conf, proxyEndpoint, libraries, timeout)
