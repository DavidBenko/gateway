...
func NewVM(
	...
	vm.InitCoreVM(core.VMCopy(proxyEndpoint.AccountID, proxyEndpoint.APIID, keyStore, endpointStore, prepare), logPrint, logPrefix, &conf, proxyEndpoint, libraries, timeout)
