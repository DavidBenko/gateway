...
//go:generate ./controller.rb --model RemoteEndpoint --account --api --check-delete --before-insert-hook --before-update-hook --after-insert-hook --after-update-hook --before-delete-hook --after-delete-hook
