...
//go:generate ./controller.rb --model API --account --before-validate-hook --after-insert-hook --after-find-hook --transform-method c.addBaseURL --transform-type enhancedAPI
